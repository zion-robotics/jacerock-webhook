...
export default function Header({ onMenuClick, title }: HeaderProps) {
  ...
  return (
    <header className="bg-white border-b border-slate-200 shadow-sm px-4 md:px-6 py-4 flex items-center justify-between sticky top-0 z-10 gap-3">
      <div className="flex items-center gap-3 min-w-0">
        ...
        <h2 className="text-slate-800 font-semibold text-base md:text-lg truncate max-w-[55vw] sm:max-w-none">{title}</h2>
      </div>
