      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4 space-y-3 min-w-0">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between gap-2 min-w-0">
              <span className="text-slate-500 flex-shrink-0">Exchange Rate</span>
            ...
            <div className="flex justify-between gap-2 min-w-0">
              ...
              <span className="font-medium text-slate-800 truncate text-right">{tx.payment_method?.replace(/_/g, ' ') || '—'}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      {tx.settlement_account_name && (
        <div className="bg-white rounded-xl border border-slate-200 p-4 min-w-0">
          ...
          <div className="bg-slate-50 rounded-lg p-4">
            <p className="text-sm text-slate-700 whitespace-pre-wrap break-words">{tx.settlement_account_name}</p>
          </div>
        </div>
      )}
